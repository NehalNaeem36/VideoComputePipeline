...
enum class BackendDevice { Cpu = 0, Cuda };
...
struct PipelineRunConfig {
    ...
    BackendDevice backendDevice = BackendDevice::Cuda;
...
const std::vector<const char *> &backend_device_names();
...
const char *to_cli(BackendDevice value);
